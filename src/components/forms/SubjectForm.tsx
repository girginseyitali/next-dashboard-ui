  ...
  return (
    <form className='flex flex-col gap-8' onSubmit={onSubmit}>
        ...
        <div className="flex justify-between flex-wrap gap-4">
            <InputField label="Subject Name" name="name" defaultValue={data?.username} register={register} error={errors.name}/>
            {data && 
            ...
            <div className="flex flex-col gap-2 w-full md:w-1/4">
                ...
                {errors.teachers?.message && <p className="text-red-400 text-xs">{errors.teachers.message}</p>}
            </div>
        </div>
